...
export const pt: Catalogo = {
  ...
  // Rótulo de impacto — eixo separado do score. Os níveis espelham o enum
  // ImpactLevel; as frases foram validadas pelo dono do produto.
  "impacto.titulo": "O QUE ESTÁ EM JOGO",
  "impacto.nivel.SHOWCASE": "VITRINE",
  "impacto.nivel.CONTACT": "CONTATO",
  "impacto.nivel.ACCOUNT": "CONTA",
  "impacto.nivel.PAYMENT": "PAGAMENTO",
  "impacto.frase.SHOWCASE": "Frágil, sem dado em risco",
  "impacto.frase.CONTACT": "Coleta dado pessoal sem proteção",
  "impacto.frase.ACCOUNT": "Conta de cliente exposta",
  "impacto.frase.PAYMENT": "Dado de pagamento em risco",
  "impacto.sensivelEm": "Sensível em",
  "impacto.verDetectado": "Ver o que foi detectado",
  "impacto.bloqueadoDica": "O que foi encontrado em cada módulo está nos planos pagos.",
  "impacto.abrirModulo": "Abrir o módulo",
  "impacto.fonte.FORM": "Formulário da página",
  "impacto.fonte.PATH": "Endereço da página",
  "impacto.fonte.COOKIES": "Cookies de sessão",
  "impacto.fonte.JWT": "Tokens JWT",
  "impacto.fonte.API_DOCS": "Documentação de API",
  "impacto.fonte.GRAPHQL": "GraphQL",
  "impacto.detalhe.form": "tem formulário",
  "impacto.detalhe.password-field": "campo de senha",
  "impacto.detalhe.pii-field": "campo de dado pessoal (e-mail, telefone, CPF)",
  "impacto.detalhe.payment-field": "campo de cartão",
  "impacto.plataforma": "Checkout gerido pela plataforma {0}: parte dos cabeçalhos é responsabilidade dela, não da loja.",
  "impacto.nivel.UNDETERMINED": "NÃO DETERMINADO",
  "impacto.indeterminado.HTTP_STATUS": "O site não deixou o scanner ler a página (HTTP {0}). O nível depende dos campos dela.",
  "impacto.indeterminado.EMPTY": "A página respondeu sem HTML para ler. O nível depende dos campos dela.",
  "impacto.indeterminado.JS_RENDERED": "A página é montada por JavaScript e os campos não vêm no HTML. O nível depende deles.",
  "impacto.indicios": "Indícios no domínio",
  "impacto.indiciosDica": "Não mudam o nível: mostram o que o domínio tem além desta página.",
  "impacto.sugestoes": "Escaneie também",
  "impacto.sugestao.ACCOUNT": "Área de conta em {0}",
  "impacto.sugestao.PAYMENT": "Checkout em {0}",
  ...
  "vazio.naoVerificado": "Esta verificação não foi executada neste scan — a ausência de achados aqui NÃO significa ausência de risco.",
  ...
  "agenda.caminho": "Caminho",
  "agenda.nAgendamentos": "{0} agendamento(s)",
  "agenda.adicionarCaminho": "+ Adicionar caminho",
  "agenda.adicionarCaminhoAjuda":
    "Preenche o formulário com este domínio — complete com o caminho e agende.",
  "agenda.pausarTodos": "Pausar todos",
  "agenda.retomarTodos": "Retomar todos",
  "agenda.expandir": "Mostrar os caminhos deste domínio",
  "agenda.recolher": "Recolher",
  "agenda.pausar": "Pausar",
  "agenda.retomar": "Retomar",
  ...
  // ── Português que escapou por não ter acento ──────────────────────────────
  // As varreduras anteriores procuravam acento ou palavra funcional, e nada disso
  // existe em "INATIVO", "Excluir conta" ou "utilizados · reseta meia-noite".
  "comum.salvar": "Salvar",
  ...
  "comum.status": "Status",
  "comum.role": "Papel",
  "comum.carregandoMinusculo": "carregando...",
  "col.risco": "RISCO",
  "achado.impacto": "IMPACTO",
  "selo.agendado": "AGENDADO",
  "selo.ausente": "AUSENTE",
  "selo.empresa": "EMPRESA",
  "card.dns.presente": "Presente",
  "card.dns.registro": "REGISTRO",
  "config.arquivoDados": "cyberaudit-meus-dados.json",

  "selo.inativo": "INATIVO",
  "selo.ativa": "ATIVA",
  "selo.revogada": "REVOGADA",
  "selo.nenhum": "NENHUM",

  "visitante.utilizados": "{0}/{1} utilizados · reseta meia-noite",
  "bloqueio.verPlanosMaiusculo": "VER PLANOS →",
  "feedback.enviarOutro": "Enviar outro",
  "setup.phDominioPrincipal": "empresa.com.br",
  "convite.expira": "· expira {0}",

  "admin.abaConvites": "Convites ({0})",
  "admin.desativar": "Desativar",
  "admin.reativar": "Reativar",
  "admin.cargo": "CARGO",
  "admin.erro": "Erro",
  "auditoria.colDataHora": "Data/Hora",
  "changes.colCampo": "Campo",
  "changes.semScanNoDia": "◈ Nenhum scan registrado neste dia.",
  "card.header.presenteOk": "✓ Header presente e configurado corretamente.",

  "config.ativarTotp": "Ativar TOTP",
  "config.desativarTotp": "Desativar TOTP",
  "config.exportarJson": "↓ Exportar JSON",
  "config.excluirConta": "Excluir conta",

  "apikey.colPrefixo": "Prefixo",
  "apikey.colCriada": "Criada",
  "marca.somenteOwnerAdmin": "Somente OWNER e ADMIN podem alterar o branding.",
  ...
  "changes.filtroImpacto": "Impacto:",
  "changes.ordenarRecentes": "Mais recentes",
  "changes.ordenarImpacto": "Maior impacto",
  "changes.impactoDominioDica": "Maior impacto entre os caminhos escaneados deste domínio",
  "changes.semDominioComImpacto": "Nenhum domínio com impacto {0}.",
...
export const en: Catalogo = {
  ...
  "impacto.titulo": "WHAT IS AT STAKE",
  "impacto.nivel.SHOWCASE": "SHOWCASE",
  "impacto.nivel.CONTACT": "CONTACT",
  "impacto.nivel.ACCOUNT": "ACCOUNT",
  "impacto.nivel.PAYMENT": "PAYMENT",
  "impacto.frase.SHOWCASE": "Fragile, no data at risk",
  "impacto.frase.CONTACT": "Collects personal data without protection",
  "impacto.frase.ACCOUNT": "Customer accounts exposed",
  "impacto.frase.PAYMENT": "Payment data at risk",
  "impacto.sensivelEm": "Sensitive in",
  "impacto.verDetectado": "See what was detected",
  "impacto.bloqueadoDica": "What was found in each module is available on paid plans.",
  "impacto.abrirModulo": "Open the module",
  "impacto.fonte.FORM": "Page form",
  "impacto.fonte.PATH": "Page address",
  "impacto.fonte.COOKIES": "Session cookies",
  "impacto.fonte.JWT": "JWT tokens",
  "impacto.fonte.API_DOCS": "API documentation",
  "impacto.fonte.GRAPHQL": "GraphQL",
  "impacto.detalhe.form": "has a form",
  "impacto.detalhe.password-field": "password field",
  "impacto.detalhe.pii-field": "personal data field (email, phone, tax ID)",
  "impacto.detalhe.payment-field": "card field",
  "impacto.plataforma": "Checkout managed by {0}: some of the headers are the platform's responsibility, not the store's.",
  "impacto.nivel.UNDETERMINED": "NOT DETERMINED",
  "impacto.indeterminado.HTTP_STATUS": "The site did not let the scanner read the page (HTTP {0}). The level depends on its fields.",
  "impacto.indeterminado.EMPTY": "The page answered with no HTML to read. The level depends on its fields.",
  "impacto.indeterminado.JS_RENDERED": "The page is built by JavaScript and its fields are not in the HTML. The level depends on them.",
  "impacto.indicios": "Signs on the domain",
  "impacto.indiciosDica": "They do not change the level: they show what the domain has beyond this page.",
  "impacto.sugestoes": "Also scan",
  "impacto.sugestao.ACCOUNT": "Account area at {0}",
  "impacto.sugestao.PAYMENT": "Checkout at {0}",
  ...
  "vazio.naoVerificado": "This check was not run in this scan — no findings here does NOT mean no risk.",
  ...
  "agenda.caminho": "Path",
  "agenda.nAgendamentos": "{0} schedule(s)",
  "agenda.adicionarCaminho": "+ Add path",
  "agenda.adicionarCaminhoAjuda":
    "Fills the form with this domain — complete it with the path and schedule.",
  "agenda.pausarTodos": "Pause all",
  "agenda.retomarTodos": "Resume all",
  "agenda.expandir": "Show the paths of this domain",
  "agenda.recolher": "Collapse",
  "agenda.pausar": "Pause",
  "agenda.retomar": "Resume",
  ...
  "comum.status": "Status",
  "comum.role": "Role",
  "comum.carregandoMinusculo": "loading...",
  "col.risco": "RISK",
  "achado.impacto": "IMPACT",
  "selo.agendado": "SCHEDULED",
  "selo.ausente": "MISSING",
  "selo.empresa": "BUSINESS",
  "card.dns.presente": "Present",
  "card.dns.registro": "RECORD",
  "config.arquivoDados": "cyberaudit-my-data.json",

  "selo.inativo": "INACTIVE",
  "selo.ativa": "ACTIVE",
  "selo.revogada": "REVOKED",
  "selo.nenhum": "NONE",

  "visitante.utilizados": "{0}/{1} used · resets at midnight",
  "bloqueio.verPlanosMaiusculo": "VIEW PLANS →",
  "feedback.enviarOutro": "Send another",
  "setup.phDominioPrincipal": "company.com",
  "convite.expira": "· expires {0}",

  "admin.abaConvites": "Invites ({0})",
  "admin.desativar": "Deactivate",
  "admin.reativar": "Reactivate",
  "admin.cargo": "JOB TITLE",
  "admin.erro": "Error",
  "auditoria.colDataHora": "Date/Time",
  "changes.colCampo": "Field",
  "changes.semScanNoDia": "◈ No scan recorded on this day.",
  "card.header.presenteOk": "✓ Header present and correctly configured.",

  "config.ativarTotp": "Enable TOTP",
  "config.desativarTotp": "Disable TOTP",
  "config.exportarJson": "↓ Export JSON",
  "config.excluirConta": "Delete account",

  "apikey.colPrefixo": "Prefix",
  "apikey.colCriada": "Created",
  "marca.somenteOwnerAdmin": "Only OWNER and ADMIN can change the branding.",
  ...
  "changes.filtroImpacto": "Impact:",
  "changes.ordenarRecentes": "Most recent",
  "changes.ordenarImpacto": "Highest impact",
  "changes.impactoDominioDica": "Highest impact across the scanned paths of this domain",
  "changes.semDominioComImpacto": "No domain with {0} impact.",
  "changes.filtroManual": "Manual",
